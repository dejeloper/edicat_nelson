        ...
        <div class="panel panel-default">
            ...
            <div id="page-stats" class="panel-collapse panel-body collapse in">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="Llave">Código Nuevo</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea disabled class="form-control" name="datos" id="datos" rows="10"
                                m><?= trim(str_replace("|", "\n", $ListaDatos[0]['Creacion'])); ?></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="observaciones">Observaciones</label>
                            <textarea disabled class="form-control" name="observaciones" id="observaciones" rows="10"
