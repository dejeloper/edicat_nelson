                ...
                <table id="<?= $Controller; ?>" class="table table-striped table-bordered" style="width:100%;">
                    ...
                    <tbody>
                        <?php
                            ...
                            <tr>
                                <td>
                                    <a href="<?= base_url() . "Clientes/Consultar/" . $item["Cliente"] . "/"; ?>" target="_blank"><?= $item["Nombre"]; ?></a>
                                </td>
                                ...
                                <td><?= $item["EstNombre"]; ?></td>
                                <td>
                                    <div class="btn-group text-center" style="margin: 0px auto;  width:100%;">
                                        <a href="#ModalCall" data-toggle="modal" title="Reportar Llamada" onclick="DatosModal('<?= $item["Pedido"]; ?>', '<?= $item["Cliente"]; ?>', '<?= $item["Nombre"]; ?>', '<?= $item["Direccion"]; ?>', '<?= $item["Telefono"]; ?>');">
                            ...
                            <div class="row hidden" id="divProPago">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="" class="form-control" id="valorPago" name="valorPago" min="0">
                                    </div>
                                </div>
                            </div>
                            <div class="row" >
        ...
        <script>
            $(document).ready(function () {
                 $('#<?= $Controller; ?>').DataTable({
                    ...
                    scrollX: true,
                    language: {
                        url: "https://Plataforma.edicat.com.co/Public/assets//lib/Datetables.js/Spanish.json"
                    }
                });
            ...
            function listar() {
                $('#<?= $Controller; ?>').DataTable({
                    ...
                    ajax: {
                        method: 'post',
                        url: "<?= base_url(); ?>Pagos/obtenerListadosClientesCobroJson/"
                    },
                    language: {
            ...
            function DatosModal(pedido, cliente, nombre, direccion, telefono) {
                $('#message').html("");
