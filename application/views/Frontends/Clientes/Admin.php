...
//                                        echo "<br><br>";
                                        ?>
                                        <tr>
                                            <td><a href="#" class="hoverData" style="color:#333;" id="<?= $item["Codigo"]; ?>"><?= $item["Nombre"]; ?></a></td>
                                            <td><a href="#" class="hoverData" style="color:#333;" id="<?= $item["Codigo"]; ?>"><?= $item["Direccion"]; ?></a></td>
                                            <td><a href="#" class="hoverData" style="color:#333;" id="<?= $item["Codigo"]; ?>"><?= $item["Telefono1"]; ?></a></td>
                                            <td><a href="#" class="hoverData" style="color:#333;" id="<?= $item["Codigo"]; ?>"><?= $item["Barrio"]; ?></a></td>
                                            <td><a href="#" class="hoverData" style="color:#333;" id="<?= $item["Codigo"]; ?>"><?= $item["PaginaFisica"]; ?></a></td>
                                            <td><a href="#" class="hoverData" style="color:#333;" id="<?= $item["Codigo"]; ?>"><?= $item["EstNombre"]; ?></a></td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    if ($accion) {
                                                        ?>
                                                        <a href = "<?= base_url() . "Clientes/CambioFecha/" . $item["Codigo"] . "/"; ?>" title = "Cambio de Fecha de Cobro"><i class = "fa fa-calendar" aria-hidden = "true" style = "padding:5px;"></i></a>
                                                        <?php
                                                    }
                                                    ...
                                                    if ($accion) {
                                                        ?>
                                                        <a href = "<?= base_url() . "Clientes/CambioTarifa/" . $item["Codigo"] . "/"; ?>" title = "Cambio de Tarifa"><i class = "fa fa-refresh" aria-hidden = "true" style = "padding:5px;"></i></a>
                                                        <?php
                                                    }
                                                    ...
                                                    if ($accion) {
                                                        ?>
                                                        <a href = "<?= base_url() . "Pagos/Generar/" . $item["Codigo"] . "/"; ?>" title = "Hacer Recibo"><i class = "fa fa-motorcycle" aria-hidden = "true" style = "padding:5px;"></i></a>
                                                        <?php
                                                    }
                                                    ...
                                                    if ($accion) {
                                                        ?>
                                                        <a href = "<?= base_url() . "Clientes/Pagos/" . $item["Codigo"] . "/"; ?>" title = "Pagos Realizados del Cliente"><i class = "fa fa-usd" aria-hidden = "true" style = "padding:5px;"></i></a>
                                                        <?php
                                                    }
                                                    ...
                                                    if ($accion) {
                                                        ?>
                                                        <a href = "#ModalDevol" data-toggle = "modal" title = "Devolución del Cliente" onclick = "DatosModal('<?= $item["Pedido"]; ?>', '<?= $item["Codigo"]; ?>', '<?= $item["Nombre"]; ?>', '<?= $item["Saldo"]; ?>', '<?= $item["Cuotas"]; ?>');"><i class = "fa fa-reply-all" aria-hidden = "true" style = "padding:5px;"></i></a>
                                                        <?php
                                                    }
